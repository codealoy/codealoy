...
export default function Announcement() {
  ...
  return hideAnnouncement ? null : (
    <div className="to-primary z-50 flex bg-linear-to-r from-[#3abff8] text-white">
      ...
      <div className="mr-3 flex shrink-0 items-center">
        ...
        >
          <HiX
            className="focus:ring-primary h-5 w-5 scale-100 transition-all duration-200 hover:scale-125 focus:ring-1 focus:outline-none focus:ring-inset active:scale-90"
            aria-hidden="true"
          />
        </Button>
      </div>
