...
export const SectionHeading = (props: SectionHeadingProps) => {
  ...
  return (
    <div className="mx-auto mb-16 max-w-xl space-y-4 text-center md:max-w-2xl">
      <p className="text-primary leading-normal font-medium">{heading}</p>
      <h2 className="text-2xl leading-normal font-bold text-slate-700 md:text-3xl lg:text-4xl dark:text-slate-200">
        {title}
      </h2>
