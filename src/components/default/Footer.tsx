...
export const Footer = () => {
  return (
    <footer className="bg-white dark:border-t dark:border-dark-300/5 dark:bg-dark-300">
          ...
          {navigation.main.map((item) => (
            <div key={item.name} className="px-5 py-2">
              <Link
                ...
                className="text-base text-slate-500 hover:text-green-600 dark:text-white dark:hover:text-green-400"
              >
                {item.name}
              </Link>
            </div>
        ...
        <div className="mt-8 flex justify-center space-x-6">
          {navigation.social.map((item) => (
            <Link
              ...
              target="_blank"
              rel="noreferrer"
              className="text-slate-400 hover:text-green-500 dark:hover:text-green-300"
            >
