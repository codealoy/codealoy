            ...
            <div>
              ...
              <div className="mt-8">
                ...
                <p className="mt-4 text-lg text-gray-500">
                  ...
                  পাশাপাশি তাই প্রাকটিস করাটাই বেশি গুরুত্বপূর্ণ।
                  <br />
                  <br />
                  কোডালয় প্ল্যাটফর্মে রয়েছে লাইভ কোডিং এডিটর ফিচার, যেটা
                  যেকোনো টপিক শেখার সাথে সাথেই প্রাকটিস করার সুযোগ দিবে। আর লাইভ
                  প্রাকটিস করতে পারায় শিক্ষণীয় বিষয়টির উপযুক্ত ব্যবহার
                  সম্পর্কে পাকাপোক্ত ধারণা পাওয়া যাবে। তাছাড়া যেকোন কনফিউশনের
                  থাকলে সেগুলোর তাৎক্ষণিক সমাধান করা সম্ভব হবে।
                </p>
                <div className="mt-8">
                  <Link href="/courses">
      ...
      <div className="mt-36">
        <div className="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8">
          <div className="mx-auto max-w-xl px-4 sm:px-6 lg:col-start-2 lg:mx-0 lg:max-w-none lg:px-0 lg:py-20">
            <div>
              <div>
                <span className="flex h-12 w-12 items-center justify-center rounded-md bg-indigo-500">
