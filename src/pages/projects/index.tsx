          ...
          <form>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="প্রজেক্ট টাইটেল দিয়ে সার্চ করুন"
                required
              ...
              <button
                type="submit"
                className="absolute items-center flex justify-center  right-2.5 bottom-2.5 rounded-lg bg-blue-700 px-4 py-[7px] text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
              >
                সার্চ করুন
              </button>
            </div>
