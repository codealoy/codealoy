...
import { MobileCourseNav } from '~/client/components/MobileCourseNav';
import { Navigation } from '~/client/components/Navigation';
import { Prose } from '~/client/components/Prose';
import { Tag } from '~/client/components/Tag';
import { NavigationItem } from '~/client/constants/navigations';
import { useTableOfContents } from '~/client/hooks/useTableOfContent';
import { getTableOfContent } from '~/client/utils/getTableOfContent';
...
const CourseContent: React.FC<{ content: any }> = ({ content }) => {
  ...
  const [lastScrolledPath, setLastScrolledPath] = React.useState(
    router.pathname,
  );
