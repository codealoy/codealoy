...
export const faqData = [
  {
    id: 1,
    question: `কোডালয় কি সম্পূর্ণ ফ্রি?`,
    answer: `হ্যাঁ। পুরো প্ল্যাটফর্ম আর সব কনটেন্ট সম্পূর্ণ বিনামূল্যে এবং ওপেনসোর্স। কোনো লুকানো খরচ নেই।`,
  },
  {
    id: 2,
    question: `শুরু করতে আমার কী কী লাগবে?`,
    answer: `একটা কম্পিউটার, পছন্দের একটা AI কোডিং টুল আর শেখার আগ্রহ। এর বেশি কিছু লাগে না।`,
  },
  {
    id: 3,
    question: `কোন AI টুল ব্যবহার করতে হবে?`,
    answer: `যেটায় আপনি স্বচ্ছন্দ সেটাই, VS Code, Cursor, Claude Code কিংবা Codex। কোডালয় আপনাকে কোনো নির্দিষ্ট টুলে বেঁধে রাখে না।`,
  },
  {
    id: 4,
    question: `Codealoy CLI কীভাবে কাজ করে?`,
    answer: `টাস্ক শেষ করে নিজের মেশিনে CLI টুলটা চালালে এটা আপনার কাজ লোকালি যাচাই করে একটা রিপোর্ট দেয়। আপনার কোড আপনার মেশিনেই থাকে।`,
  },
  {
    id: 5,
    question: `আগে থেকে প্রোগ্রামিং জানা কি বাধ্যতামূলক?`,
    answer: `না। একদম গোড়া থেকে শুরু করা যায়। ধাপে ধাপে প্রোগ্রামিং আর এজেন্টিক ডেভেলপমেন্ট, দুটোই শেখানো হয়।`,
  },
  {
    id: 6,
    question: `আমি কীভাবে অবদান রাখতে পারি?`,
    answer: `কোডালয় ওপেনসোর্স, তাই যে কেউ অবদান রাখতে পারে। গিটহাবে এসে কনটেন্ট লেখা, ভুল সংশোধন কিংবা কোডে অবদান রাখতে পারেন।`,
  },
];
